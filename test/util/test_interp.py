...
class TestInterp(unittest.TestCase):
    ...
    def test_left_interp_on_a_vector(self):
        ...
        res = left_interp(self.interp_indices, self.interp_values, vector).data
    ...
    def test_batch_left_interp_on_a_vector(self):
        ...
        res = left_interp(self.batch_interp_indices, self.batch_interp_values, vector).data
        self.assertTrue(approx_equal(res, actual))
    ...
    def test_batch_left_t_interp_on_a_vector(self):
        ...
        res = left_t_interp(self.batch_interp_indices, self.batch_interp_values, vector, 6).data
        self.assertTrue(approx_equal(res, actual))

    def test_left_interp_on_a_matrix(self):
        matrix = torch.randn(6, 3)

        res = left_interp(self.interp_indices, self.interp_values, matrix).data
    ...
    def test_left_t_interp_on_a_matrix(self):
        ...
        res = left_t_interp(self.interp_indices, self.interp_values, matrix, 6).data
    ...
    def test_batch_left_interp_on_a_matrix(self):
        ...
        res = left_interp(self.batch_interp_indices, self.batch_interp_values, batch_matrix).data
    ...
    def test_batch_left_t_interp_on_a_matrix(self):
        ...
        res = left_t_interp(self.batch_interp_indices, self.batch_interp_values, batch_matrix, 6).data
