...
class TestInterp(unittest.TestCase):
    def setUp(self):
        self.interp_indices = Variable(torch.LongTensor([[2, 3], [3, 4], [4, 5]])).repeat(3, 1)
        self.interp_values = Variable(torch.Tensor([[1, 2], [0.5, 1], [1, 3]])).repeat(3, 1)
        self.interp_indices_2 = Variable(torch.LongTensor([[0, 1], [1, 2], [2, 3]])).repeat(3, 1)
        self.interp_values_2 = Variable(torch.Tensor([[1, 2], [2, 0.5], [1, 3]])).repeat(3, 1)
    ...
    def test_left_interp_on_a_vector(self):
        ...
        res = left_interp(self.interp_indices, self.interp_values, Variable(vector)).data
    ...
    def test_left_t_interp_on_a_vector(self):
        ...
        res = left_t_interp(self.interp_indices, self.interp_values, Variable(vector), 6).data
    ...
    def test_batch_left_interp_on_a_vector(self):
        ...
        res = left_interp(self.batch_interp_indices, self.batch_interp_values, Variable(vector)).data
        self.assertTrue(approx_equal(res, actual))
    ...
    def test_batch_left_t_interp_on_a_vector(self):
        ...
        res = left_t_interp(self.batch_interp_indices, self.batch_interp_values, Variable(vector), 6).data
        self.assertTrue(approx_equal(res, actual))

    def test_left_interp_on_a_matrix(self):
        matrix = torch.randn(6, 3)

        res = left_interp(self.interp_indices, self.interp_values, Variable(matrix)).data
    ...
    def test_left_t_interp_on_a_matrix(self):
        ...
        res = left_t_interp(self.interp_indices, self.interp_values, Variable(matrix), 6).data
    ...
    def test_batch_left_interp_on_a_matrix(self):
        ...
        res = left_interp(self.batch_interp_indices, self.batch_interp_values, Variable(batch_matrix)).data
    ...
    def test_batch_left_t_interp_on_a_matrix(self):
        ...
        res = left_t_interp(self.batch_interp_indices, self.batch_interp_values, Variable(batch_matrix), 6).data
