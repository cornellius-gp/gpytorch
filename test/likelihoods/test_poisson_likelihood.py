...
from gpytorch.likelihoods import _OneDimensionalLikelihood, PoissonLikelihood
from gpytorch.test.base_likelihood_test_case import BaseLikelihoodTestCase


class TestPoissonLikelihood(BaseLikelihoodTestCase, unittest.TestCase):
    seed = 1
    ...
    def create_likelihood(self, **kwargs):
        return PoissonLikelihood(**kwargs)
