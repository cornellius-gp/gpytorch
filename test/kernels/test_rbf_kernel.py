...
from gpytorch.kernels.rbf_kernel import rbf_forward, rbf_forward_and_vjp, SparseQuadForm
...
class TestRBFKernel(unittest.TestCase, BaseKernelTestCase):
    ...
    def test_custom_forward_and_vjp(self):
        ...
        _, (x1_grad, x2_grad) = rbf_forward_and_vjp(x1_clone, x2_clone, V)
    ...
    def test_sparse_quad_form(self):
        ...
        # Test custom forward
        ST_K_S_custom = SparseQuadForm.apply(X_clone, Sv_clone, Si, rbf_forward, rbf_forward_and_vjp, 1)
