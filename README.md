...
If you install libfftw3 from source, be sure to configure with `--enable-shared`. Our build script automatically looks for libraries in `/usr/local/lib`, which is the default installation
