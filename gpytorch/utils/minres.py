...
@torch.jit.script
def minres(matmul_closure, rhs, shifts, value=torch.tensor(-1.), max_num_iter=torch.tensor(100)):
    # Default values
    max_num_iter = max_num_iter.item()
    ### CHANGE 1: always assume matmul_closure is a tensor
