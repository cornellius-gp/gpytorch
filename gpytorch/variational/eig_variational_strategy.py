...
class EigVariationalStrategy(_VariationalStrategy):
    r"""
    ...
    :param ~gpytorch.models.ApproximateGP model: Model this strategy is applied to.
        Typically passed in when the EigVariationalStrategy is created in the
    ...
    def forward(self, x, inducing_points, inducing_values, variational_inducing_covar=None):
        if variational_inducing_covar is not None:
            raise RuntimeError("EigVariationalStrategy currently does not handle the variational_inducing_covar")
