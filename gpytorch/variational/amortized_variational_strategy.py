...
from ._amortized_variational_strategy import _AmortizedVariationalStrategy
...
class AmortizedVariationalStrategy(_AmortizedVariationalStrategy):
    def __init__(self, model, inducing_point_model, variational_distribution_model, minibatch_size):
        super().__init__(model, inducing_point_model, variational_distribution_model)
    ...
    def prior_distribution(self):
        zeros = torch.zeros(self.minibatch_size).to(device=self.updated_strategy.device)
