...
from ..distributions import MartinDistribution
from .variational_distribution import VariationalDistribution


class MartinVariationalDistribution(VariationalDistribution):
    """
    ...
    def __init__(self, num_inducing_points, batch_size=None):
        ...
        nu_init = 2 * torch.ones(num_inducing_points)
        ...
        self.register_constraint("raw_nu_constraint", GreaterThan(2.))
    ...
    @property
    def nu(self):
        self.raw_nu_constraint.transform(self.raw_nu)
