...
class DGPVariationalStrategy(Module):
    """
    ...
    def __init__(self, model, inducing_points, variational_distribution, learn_inducing_locations=False):
        ...
        """
        super(DGPVariationalStrategy, self).__init__()
    ...
    def forward(self, x):
        ...
        # Otherwise, we have to marginalize
            ...
            predictive_covar = RootLazyTensor(inv_products[..., 1:, :].transpose(-1, -2)).diag()
            if beta_features.diagonal_correction.on():
                ...
                predictive_covar = predictive_covar + diag_correction
            ...
            return torch.distributions.Normal(predictive_mean, predictive_covar.sqrt())
    ...
    def __call__(self, x):
        ...
        return super(DGPVariationalStrategy, self).__call__(x)
