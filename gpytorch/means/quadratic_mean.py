...
class QuadraticMean(Mean):
    def __init__(
        ...
        raw_weights_constraint=None,
        raw_bias_constraint=None,
        raw_quadratic_weights_constraint=None,
        weights_prior=None,
        bias_prior=None,
        ...
        self.register_parameter(
            name="raw_quadratic_weights", parameter=torch.nn.Parameter(torch.zeros(*batch_shape, input_size, 1)),
        )
        ...
        if use_weights:
            self.register_parameter(
                name="weights", parameter=torch.nn.Parameter(torch.randn(*batch_shape, input_size, 1)),
            )
