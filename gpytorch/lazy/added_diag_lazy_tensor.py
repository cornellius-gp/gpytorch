...
from ..utils import broadcasting, pivoted_cholesky, learning_low_rank_preconditioner
...
class AddedDiagLazyTensor(SumLazyTensor):
    ...
    def _lr_preconditioner(self):
        ...
        if self._q_cache is None:
            ...
            if settings.learning_preconditioner.on():
                self._piv_chol_self = learning_low_rank_preconditioner(
                    self._lazy_tensor,
                    max_iter,
                )
            else:
