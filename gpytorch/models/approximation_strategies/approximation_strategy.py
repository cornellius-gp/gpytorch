...
class ApproximationStrategy(abc.ABC, Module):
    ...
    def register_cached_quantity(
        ...
        clear_cache_on: Optional[List[str]] = ["model_parameter_backward", "train_inputs_set", "train_targets_set"],
    ) -> None:
        ...
        :param clear_cache_on: When to automatically clear the cached quantity.
            Zero or more of: ``["model_parameter_backward", "set_train_inputs", "set_train_targets"]``.
        """
        ...
        if clear_cache_on is not None:
            for clear_cache_trigger in clear_cache_on:
                if clear_cache_trigger == "model_parameter_backward":
