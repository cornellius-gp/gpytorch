...
class PeriodicKernel(Kernel):
    def __init__(self, log_lengthscale_prior=None, log_period_length_prior=None, eps=1e-5, active_dims=None):
        super(PeriodicKernel, self).__init__(
            has_lengthscale=True, active_dims=active_dims, log_lengthscale_prior=log_lengthscale_prior
        )
        self.eps = eps
