...
try:
    ...
    class PeriodicKernel(GPeriodicKernel, KeOpsKernel):
        ...
        def covar_func(self, x1, x2, lengthscale, diag=False, **kwargs):
            ...
            with torch.autograd.enable_grad():
                if (
                    ...
                    return self._nonkeops_covar_func(x1, x2, lengthscale, diag=diag)
        ...
        def forward(self, x1, x2, diag=False, **kwargs):
            ...
            # pass any parameters which are used inside the kernel
            # as *args to get gradients computed for them
            return KernelLinearOperator(x1_, x2_, self.lengthscale, covar_func=self.covar_func, diag=diag, **kwargs)
